...
Insert into AUTORACLE.CATEGORIA (IDCATEGORIA,NOMBRE) values ('333','Piloto automático ');
...
Insert into AUTORACLE.EMPLEADO (IDEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,FECENTRADA,DESPEDIDO,SUELDOBASE,HORAS,PUESTO,RETENCIONES) values ('2','Miguel','Molina','Martín',to_date('23/03/20','DD/MM/RR'),'0','1068,75','40',null,null);
...
SET DEFINE OFF;
Insert into AUTORACLE.LOTE ("NÚMERO_DE_PIEZAS",PIEZA_CODREF,COMPRA_IDCOMPRA,IVA) values ('3','17447','5','21');
