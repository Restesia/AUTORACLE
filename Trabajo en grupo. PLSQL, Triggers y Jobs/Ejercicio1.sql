...
-- DAMOS PERMISOS A LOS ROLES:
    ...
    */
    ...
    CREATE OR REPLACE VIEW VSERVICIOM AS (SELECT * FROM SERVICIO S JOIN TRABAJA T ON (S.IDSERVICIO = T.SERVICIO_IDSERVICIO) JOIN EMPLEADO E ON (E.IDEMPLEADO = T.EMPLEADO_IDEMPLEADO) WHERE UPPER(E.USERNAME) = UPPER(USER));
    
    GRANT SELECT ON VDATOSEMPL TO R_MECANICO;
    GRANT SELECT ON VFACTURA TO R_MECANICO;
    GRANT SELECT ON VVACACIONES TO R_MECANICO;
    GRANT SELECT ON VSERVICIOM TO R_MECANICO;
