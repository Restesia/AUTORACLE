...
-- DAMOS PERMISOS A LOS ROLES:
  ...
  --  GRANT SELECT ON VACACIONES TO R_MECANICO;
    ...
    --CREATE OR REPLACE VIEW VVACACIONES AS (SELECT * FROM VACACIONES V JOIN EMPLEADO E ON (V.EMPLEADO_IDEMPLEADO=E.IDEMPLEADO) WHERE UPPER(E.USERNAME) = UPPER(USER));
    
    
    GRANT SELECT ON VDATOSEMPL TO R_MECANICO;
    GRANT SELECT ON VFACTURAS TO R_MECANICO;
